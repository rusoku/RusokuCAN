...
echo " *  TouCAN - macOS User-Space Driver for Rusoku TouCAN USB Adapters" >> ./Sources/build_no.h
echo " *" >> ./Sources/build_no.h
echo " *  Copyright (c) 2020-2024 Uwe Vogt, UV Software, Berlin (info@mac-can.com)" >> ./Sources/build_no.h
echo " *  All rights reserved." >> ./Sources/build_no.h
echo " *" >> ./Sources/build_no.h
echo " *  This file is part of MacCAN-TouCAN." >> ./Sources/build_no.h
echo " *" >> ./Sources/build_no.h
echo " *  MacCAN-TouCAN is dual-licensed under the BSD 2-Clause \"Simplified\" License" >> ./Sources/build_no.h
echo " *  and under the GNU General Public License v3.0 (or any later version). You can" >> ./Sources/build_no.h
echo " *  choose between one of them if you use MacCAN-TouCAN in whole or in part." >> ./Sources/build_no.h
echo " *" >> ./Sources/build_no.h
...
echo " *" >> ./Sources/build_no.h
echo " *  MacCAN-TouCAN IS PROVIDED BY THE COPYRIGHT HOLDERS AND CONTRIBUTORS \"AS IS\"" >> ./Sources/build_no.h
...
echo " *  OF MacCAN-TouCAN, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGE." >> ./Sources/build_no.h
echo " *" >> ./Sources/build_no.h
...
echo " *  along with MacCAN-TouCAN.  If not, see <https://www.gnu.org/licenses/>." >> ./Sources/build_no.h
echo " */" >> ./Sources/build_no.h
